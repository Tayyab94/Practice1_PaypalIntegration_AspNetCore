...
using Delaney.Services.Data.Core;
    ...
    public class CheckoutController : Controller
    {
       ...
       /// <returns></returns>
        public IActionResult Index()
        {
            ...
            ViewBag.ClientId =PayPal.PayPalClient.SandboxClientId; // Get from a 
        ...
        public async Task<PayPal.SmartButtonHttpResponse> Create()
        {
           ...
           request.RequestBody(PayPal.OrderBuilder.Build(unitOfWork));
