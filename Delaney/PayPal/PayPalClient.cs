...
namespace PayPal
{
    ...
    {  // Place these static properties into a settings area.
        public static string SandboxClientId { get; set; } = "AT8FTxWvkxI-ZyHBmUKEd9hZ2i3JyUpg04USwFO2evQMh1Nv5xOMZ8n5GQaD1F3WiESkCriT0kfRStf-";
        public static string SandboxClientSecret { get; set; } = "EJpR1bH7v2RErQHqkYonqOvg2EjRGdcZiTttF5ni_PS0zcoalbTwz9TdQ9mBmqa3owraowROju-VAGCy";
